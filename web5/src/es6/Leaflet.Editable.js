...
import {Evented, extend, Handler, Browser} from 'leaflet/src/core/index.js'
import * as Util from 'leaflet/src/core/Util.js';
import * as LineUtil from 'leaflet/src/geometry/LineUtil.js';
import * as DomEvent from 'leaflet/src/dom/DomEvent.js';
import {toLatLng,LatLng} from 'leaflet/src/geo/LatLng.js'
...
import {DivIcon, Marker} from 'leaflet/src/layer/marker/index.js'
// import {MarkerDrag} from 'leaflet/src/layer/marker/Marker.Drag.js'
import {getPosition, addClass, removeClass} from 'leaflet/src/dom/DomUtil.js'
import {Draggable} from 'leaflet/src/dom//Draggable.js';
import {LayerGroup} from 'leaflet/src/layer/LayerGroup.js'
import {Circle} from  'leaflet/src/layer/vector/Circle.js';
import {Polyline, polyline} from  'leaflet/src/layer/vector/Polyline.js';
import {Polygon} from  'leaflet/src/layer/vector/Polygon.js';
import {Rectangle} from  'leaflet/src/layer/vector/Rectangle.js';
...
export var Editable = Evented.extend({
    ...
    createLineGuide: function () {
        var options = Util.extend({dashArray: '5,10', weight: 1, interactive: false}, this.options.lineGuideOptions);
...
Editable.PolygonEditor = Editable.PathEditor.extend({
    ...
    vertexCanBeDeleted: function (vertex) {
        var parent = this.feature.parentShape(vertex.latlngs),
            idx = Util.indexOf(parent, vertex.latlngs);
...
var PolygonMixin = {
    ...
    parentShape: function (shape, latlngs) {
        latlngs = latlngs || this._latlngs;
        if (!latlngs) return;
        var idx = Util.indexOf(latlngs, shape);
        if (idx !== -1) return latlngs;
        for (var i = 0; i < latlngs.length; i++) {
            idx = Util.indexOf(latlngs[i], shape);
...
var isFlat = LineUtil.isFlat || LineUtil._flat || Polyline._flat;  // <=> 1.1 compat.
